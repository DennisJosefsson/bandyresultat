...
const Compare = () => {
  ...
  if (error) {
    return (
      <div className="max-w-6xl mx-auto min-h-screen"> There was an error</div>
    )
  }
            ...
            <div className="w-56">
              ...
              <table className="mb-3 w-56">
                ...
                <tbody>
                  {seasons.map((team) => {
                    return (
                      <tr key={team.team} className="odd:bg-slate-300 rounded">
                        <td className="px-1 py-1">{team.casual_name}</td>
                        <td className="px-1 py-1 text-right">{team.seasons}</td>
                      </tr>
                    )
                  })}
                </tbody>
