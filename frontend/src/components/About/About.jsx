...
const About = () => {
  return (
    <div className="max-w-7xl min-h-screen mx-auto font-inter text-[#011d29] px-2 md:px-10 xl:px-0">
      <div className="flex flex-col justify-start [@media(min-width:1000px)]:flex-row [@media(min-width:1000px)px]:justify-between gap-4">
        <div className="mx-10 lg:mx-0 lg:w-1/2">
          <h2 className="text-base md:text-xl font-bold mb-2 md:mb-4 text-center [@media(min-width:1000px)]:text-left">
            Om det här projektet
          </h2>
          <p className="text-sm md:text-base mb-2 text-justify">
          ...
          <p className="text-sm md:text-base mb-2 text-justify">
            ...
            (särskilt från tiden före 1990). Det blir nästa del av
            pro&shy;jektet.
          </p>
          <p className="text-sm md:text-base mb-2 text-justify">
        ...
        <div className="mx-10 lg:mx-0 lg:w-2/5">
          <p className="text-sm md:text-base mb-2 text-justify [@media(min-width:1000px)]:mt-10">
          ...
          <h4 className="text-base md:text-lg font-bold mb-2 md:mb-4 text-center">
