...
const Search = () => {
  ...
  return (
    <div
      className="font-inter mx-auto mt-2 flex min-h-screen max-w-7xl flex-col text-[#011d29]"
      ref={topRef}
    >
      <TabBarDivided
            ...
            <div className="flex max-h-[160px] flex-col gap-4">
              <div>
                <input
                  ...
                  value="Sök"
                  form="search-form"
                  className="xs:w-[84px] xs:text-sm w-[72px] cursor-pointer truncate rounded-md bg-[#011d29] px-1 py-0.5 text-center text-[10px] text-white transition-all duration-150 ease-in-out first:last:px-1 hover:bg-slate-600 lg:w-[128px] lg:px-2 lg:py-1 lg:text-base"
                  onClick={() => collapse()}
                />
              </div>
